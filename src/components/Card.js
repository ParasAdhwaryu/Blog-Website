  ...
  return (
    ...
    >
      ...
      <div className="card-body my-2">
        ...
        <div
          className="d-flex felx-wrap  justify-content-center rounded-pill"
          style={{
        ...
        <p className="card-text my-3">
          ...
          >
            {" "}
            Read More
            <ArrowForwardIosRoundedIcon style={{ height: "15px" }} />
          </Link>
        </p>
